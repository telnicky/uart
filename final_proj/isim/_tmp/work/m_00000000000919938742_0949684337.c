...
#endif
static const char *ng0 = "C:/Code/uart/final_proj/sender.v";
static int ng1[] = {1, 0};
static int ng2[] = {0, 0};
static int ng3[] = {8, 0};
...
LAB21:    xsi_set_current_line(71, ng0);
    ...
    *((unsigned int *)t31) = t42;
    t43 = (t0 + 2116);
    xsi_vlogvar_assign_value(t43, t35, 0, 0, 1);
    goto LAB45;
...
LAB82:    memcpy(t9, t37, 8);

LAB83:    t38 = (t0 + 2668);
    xsi_vlogvar_assign_value(t38, t9, 0, 0, 5);
    goto LAB36;
...
LAB99:    memcpy(t9, t37, 8);

LAB100:    t47 = (t0 + 2668);
    xsi_vlogvar_assign_value(t47, t9, 0, 0, 5);
    goto LAB36;
...
LAB163:    if (*((unsigned int *)t28) > 0)
        goto LAB164;

LAB165:    if (*((unsigned int *)t10) > 0)
        goto LAB166;

LAB167:    memcpy(t9, t37, 8);
...
LAB233:    if (*((unsigned int *)t10) > 0)
        goto LAB234;

LAB235:    memcpy(t9, t37, 8);
...
LAB267:    if (*((unsigned int *)t10) > 0)
        goto LAB268;

LAB269:    memcpy(t9, t37, 8);
...
LAB45:    xsi_vlog_unsigned_bit_combine(t9, 32, t23, 32, t30, 32);
    goto LAB49;

LAB47:    memcpy(t9, t23, 8);
    goto LAB49;
...
LAB62:    xsi_vlog_unsigned_bit_combine(t9, 32, t22, 32, t37, 32);
    goto LAB66;

LAB64:    memcpy(t9, t22, 8);
    goto LAB66;
...
LAB79:    xsi_vlog_unsigned_bit_combine(t9, 32, t28, 32, t37, 32);
    goto LAB83;

LAB81:    memcpy(t9, t28, 8);
    goto LAB83;
...
LAB96:    xsi_vlog_unsigned_bit_combine(t9, 32, t31, 32, t37, 32);
    goto LAB100;

LAB98:    memcpy(t9, t31, 8);
    goto LAB100;
...
LAB113:    xsi_vlog_unsigned_bit_combine(t9, 32, t31, 32, t37, 32);
    goto LAB117;

LAB115:    memcpy(t9, t31, 8);
    goto LAB117;
...
LAB130:    xsi_vlog_unsigned_bit_combine(t9, 32, t31, 32, t37, 32);
    goto LAB134;

LAB132:    memcpy(t9, t31, 8);
    goto LAB134;
...
LAB147:    xsi_vlog_unsigned_bit_combine(t9, 32, t31, 32, t37, 32);
    goto LAB151;

LAB149:    memcpy(t9, t31, 8);
    goto LAB151;
...
LAB164:    xsi_vlog_unsigned_bit_combine(t9, 32, t31, 32, t37, 32);
    goto LAB168;

LAB166:    memcpy(t9, t31, 8);
    goto LAB168;
...
LAB181:    xsi_vlog_unsigned_bit_combine(t9, 32, t31, 32, t37, 32);
    goto LAB185;

LAB183:    memcpy(t9, t31, 8);
    goto LAB185;
...
LAB198:    xsi_vlog_unsigned_bit_combine(t9, 32, t31, 32, t37, 32);
    goto LAB202;

LAB200:    memcpy(t9, t31, 8);
    goto LAB202;
...
LAB215:    xsi_vlog_unsigned_bit_combine(t9, 32, t31, 32, t37, 32);
    goto LAB219;

LAB217:    memcpy(t9, t31, 8);
    goto LAB219;
...
LAB232:    xsi_vlog_unsigned_bit_combine(t9, 32, t31, 32, t37, 32);
    goto LAB236;

LAB234:    memcpy(t9, t31, 8);
    goto LAB236;
...
LAB249:    xsi_vlog_unsigned_bit_combine(t9, 32, t31, 32, t37, 32);
    goto LAB253;

LAB251:    memcpy(t9, t31, 8);
    goto LAB253;
...
LAB266:    xsi_vlog_unsigned_bit_combine(t9, 32, t31, 32, t37, 32);
    goto LAB270;

LAB268:    memcpy(t9, t31, 8);
    goto LAB270;

}


extern void work_m_00000000000919938742_0949684337_init()
{
	static char *pe[] = {(void *)A31_0,(void *)A55_1,(void *)A63_2,(void *)A93_3};
	xsi_register_didat("work_m_00000000000919938742_0949684337", "isim/_tmp/work/m_00000000000919938742_0949684337.didat");
